...
import { ToastProps } from './Notification.types';
...
const Toast: React.FC<ToastProps> = ({
  ...
  return createPortal(
    <div
      className={`fixed ${positionStyles[position]} max-w-sm w-full transition-opacity duration-300 ease-in-out ${
        isVisible ? 'opacity-100' : 'opacity-0'
      }`}
      style={{ zIndex: 9999 }}
    >
      <div className={`rounded-lg shadow-lg overflow-hidden ${typeStyles[type]}`}>
        <div className="p-4">
